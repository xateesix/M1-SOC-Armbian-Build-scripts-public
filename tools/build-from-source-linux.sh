...
(
    cd "$PROJECT_ROOT"
    RK3308BS_TSADC="$RK3308BS_TSADC" GOODIX_FACTORY_DEFAULTS="$GOODIX_FACTORY_DEFAULTS" DISABLE_THERMAL_CRITICAL="$DISABLE_THERMAL_CRITICAL" DISABLE_TSADC="$DISABLE_TSADC" EXTRA_BOOTARGS="$EXTRA_BOOTARGS" bash ./build-emmc-release.sh \
