...
The image build stages KIAUH, Klipper, Moonraker, KlipperScreen, and Crowsnest source trees under `/opt` during rootfs customization; run `rk3308bs-setup-companion-stack` on device to install KlipperScreen/Crowsnest via KIAUH.
